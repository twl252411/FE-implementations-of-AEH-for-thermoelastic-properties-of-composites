...
#
RF = np.loadtxt(f'{new_job_name}_ini_nd_for.txt', delimiter=',')
...
#
for inum in range(ndnum):
	addlns4.append('** Name: Load-'+str(inum+1)+' Type: Concentrated force\n')
	addlns4.append('*Cload, op=NEW\n')
	addlns4.append('Set-'+str(inum+1)+', 1, '+str(RF[inum,1])+'\n')
	addlns4.append('Set-'+str(inum+1)+', 2, '+str(RF[inum,2])+'\n')
	addlns4.append('Set-'+str(inum+1)+', 3, '+str(RF[inum,3])+'\n')
#
addlns4.append('** \n')
