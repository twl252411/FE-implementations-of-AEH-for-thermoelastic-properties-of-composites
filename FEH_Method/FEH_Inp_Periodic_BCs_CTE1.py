#
import numpy as np
from pbc_matching_utils import build_periodic_set_lines
...
#----------------------------- Modify Job name ------------------------------
#
lines[1] = f'** Job name: {job_name} Model name: Model-1\n'
#
...
addlnsE9, addlnsE10, addlnsE11, addlnsE12, addlnsE13, addlnsE14 = build_periodic_set_lines(
	ndcord,
	NdRS=NdRS,
	NdLS=NdLS,
	NdTS=NdTS,
...
addlns4.append('** \n')
addlns4.append('** Name: Predefined Field-1 Type: Temperature\n')
addlns4.append('*Initial Conditions, type=TEMPERATURE \n')
addlns4.append('Set-T, 0. \n')
addlns4.append('** ----------------------------------------------------------------\n')
addlns4.append('** \n')
