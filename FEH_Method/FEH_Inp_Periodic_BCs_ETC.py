...
#----------------------------- Parameters ------------------------------
#
# yarn_w, yarn_h, yarn_sec1, yarn_sec2, extra_t = 2.0 * 2, 0.6, 1.9 * 2, 0.4, 0.2 / 4
# rve_t = (yarn_h + yarn_sec2) * (1.0 + extra_t)
# rve_size = np.array([2.0 * yarn_w + extra_t, 4.0 * rve_t, 2.0 * yarn_w + extra_t])
